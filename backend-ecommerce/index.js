...
MongoClient.connect(url, (err, client) => {
  ...
  app.get("/produto", verifyJWT, (req, res) => {
  ...
  app.get("/produto/:id", verifyJWT, (req, res) => {
  ...
  app.put("/produto/:id", verifyJWT, (req, res) => {
    let id = new ObjectId(req.params.id);

    db.collection("produto").updateOne(
      { _id: id },
      {
        $set: {
          nome: req.body.nome,
  ...
  app.delete("/produto/:id", verifyJWT, (req, res) => {
    let id = new ObjectId(req.params.id);
    db.collection("produto").deleteOne({ _id: id }, (err, result) => {
